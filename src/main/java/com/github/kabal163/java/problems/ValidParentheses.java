...
Необходимо определить, является ли строка валидной последовательностью или нет.

- Каждая открывающая скобка должна иметь соответствующую закрывающую (и наоборот)
...
Вход: «[]»
Выход: true
Поясление: две скобки - сначала скобка открывается, затем закрывается

Пример №2
=============
Вход: «[{]}»
Выход: false
Появнение: закрытие скобок происходит в неправильной последовательности
