...
/*
Теперь, когда вы знаете о Java почти все, вы можете создать свою первую программу.
Давайте сделаем простенький калькулятор. Что я хочу видеть:
- В методе main две переменных типа double, которым можно задавать разные значения.
- В этом же классе несколько других методов, каждый из которых будет соответствовать операциям сложения,
  вычитания, умножения, деления, получение остатка от деления, возведение в степень.
